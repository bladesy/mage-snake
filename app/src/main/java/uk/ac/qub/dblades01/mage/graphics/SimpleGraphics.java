...
public class SimpleGraphics implements Graphics {
    ...
    /* assetManager creates Pixmaps, while the frameBuffer is drawn on by canvas. */
    ...
    public Pixmap newPixmap(String bitmapName, PixmapFormat format) {
        ...
        /* Set to null inorder to later check whether an instance has been succesfully created. */
        bitmapInput = null;
